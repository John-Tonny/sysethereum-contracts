...
// Interface contract to be implemented by VircleERC20Manager
interface VircleTransactionProcessor {
    ...
    function freezeBurnERC20(uint value, uint32 assetGUID, address erc20ContractAddress, uint8 precision, bytes calldata vircleAddress) external returns (bool);
